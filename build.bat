...
SET WARNINGS=-Wall -Wextra -Wno-missing-braces -Wno-logical-op-parentheses -Wno-c99-designator -Wno-initializer-overrides -Wno-c++20-extensions -Wno-char-subscripts -Wno-unneeded-internal-declaration
